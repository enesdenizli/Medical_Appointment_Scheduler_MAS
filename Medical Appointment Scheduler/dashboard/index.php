                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample login-form" name="app_form" id="app_form" method="post">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="exampleFormControlSelect" name="physician_id" required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="exampleFormControlSelect" name="nurse_id" required>
                                    <option value="">Choose</option>
                                    <?php
                            ...
                            foreach ($get_appointment as $appointment) {
                                ...
                                <tr>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <td>
                                            <a href="info.php?patient_id=<?php echo $appointment['patient_id']; ?>"><?php echo $get_patient_name[0]['first_name'] . " " . $get_patient_name[0]['last_name']; ?></a>
                                        </td>
...
<script type="text/javascript">
    // Submit create event Data using Modal
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data == 'true') {
                    ...
                    Swal.fire("Done!", "Appoitnemnt added successfully!", "success");
                    ...
                    Swal.fire("Error!", "Sorry, there was an error! Appoitnemnt scheduling Failed.!", "error");
                }
            },
            cache: false,
            contentType: false,
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        console.log(data);
                        Swal.fire("Done!", "Appoitnemnt deleted!", "success");
                        window.setTimeout(function () {
                            location.reload()
                        }, 1000)
